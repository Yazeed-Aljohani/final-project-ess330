...
us_bbox <- c(
  xmin = -125,  # West longitude
  xmax = -66,    # East longitude
  ymin = 24,     # South latitude
...
map_co2 <- ms_simplify(map_co2, keep = 0.1)
...
map_co2 <- ms_simplify(map_mobility, keep = 0.1)
...
#This code is categorizing emissions into the categroies of high and low. Why? Why is an unpaired t-test performed? Why don't we have an f-test to test for variance first?
...
ggscatter(joined_data, x = date, y = emissionsmo)
